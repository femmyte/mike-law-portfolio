...
const page = () => {
	...
	return (
		<>
			...
			<main>
				<section className='flex flex-col md:flex-row items-center pl-[20px] md:pl-[70px] h-[100vh]  overflow-y-hidden relative'>
					<div className='text-black flex-1'>
						<h1 className='font-[700] text-[50px] md:text-[102px] leading-[50px] md:leading-[102px]'>
							Law with a special touch.
						</h1>
						<p className='font-[400] text-[14px] md:text-[16px] leading-[24px] mt-[20px] md:mt-[32px]'>
					...
					<div className='flex-1'>
						<img
							src='/images/hero.png'
							className='hidden md:block h-[735px] absolute right-[0px] top-0 bottom-0'
							alt='hero bg'
						/>
						<img
							src='/images/mobile/hero-mobile.png'
							className='md:hidden block absolute right-0 bottom-0 top-[30%]'
							alt='hero bg'
						/>
					</div>
				</section>
...
'
				...
				<Animation style='fade-down-right' placement='center-center'>
					<section className="relative bg-[url('/images/mobile/client-bg.png')] md:bg-[url('/images/client-bg.png')] h-[369px] bg-cover bg-center overflow-hidden">
						<div
